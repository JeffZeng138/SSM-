...
<p style="float:right;">
	...
	<c:if test="${account != null }">
      ...
      <div>
        <img src="../resources/home/images\brand_quanji.jpg" alt="" height="256px" width="1200px">
          <span style="position: absolute; top: 130px; left: 530px;color: white;font-size: 24px;font-weight: bold">不打烊酒店,欢迎您!</span>
